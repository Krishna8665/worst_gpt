    ...
    <div className="font-sans bg-white text-gray-900 min-h-screen flex flex-col">
      ...
      <section className="pt-28 pb-16 px-4 text-center max-w-4xl mx-auto">
        ...
        <p className="text-lg max-w-xl mx-auto mb-8 text-gray-700">
          WorstGPT is the chatbot that tells it like it is — brutally, sarcastically, and
      ...
      <section id="features" className="py-20 px-4 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-center">What Makes WorstGPT Awful</h2>
        <div className="grid md:grid-cols-3 gap-12 text-left text-gray-800">
          <div>
            <h3 className="text-xl font-semibold mb-3">Painfully Honest Replies</h3>
            <p>We don’t sugarcoat anything. We coat it in sarcasm and throw it back.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-3">Daily Limit? Good.</h3>
            <p>You get 10 messages per day. Because you probably can't handle more.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-3">Premium Mockery</h3>
            <p>Pay monthly to get insulted more frequently. Worth every penny.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-8">Users Hate It (Which Means It Works)</h2>
